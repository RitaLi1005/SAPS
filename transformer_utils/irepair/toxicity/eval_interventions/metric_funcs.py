...
from irepair.toxicity.PerspectiveAPI import (
    PerspectiveAPI,
    parse_response_payload as parse_toxic_scores,
)
from irepair.toxicity.eval_interventions.hook_utils import hook_subtract
from irepair.utils import VERBOSE
import pandas as pd
import json
import time
rate_limit = 20
...
def run_perplexity(
    ...
    data,
    intervene_results,
    config,seed,percentage,sample_alpha
):
    """
...
def run_perspective_api(
    ...
    # print("xxxx:")
    # print(generations)
    path=f"/root/autodl-tmp/mnt/project3_dataselection/transformer_utils/irepair/data/result/output_all{seed}_{percentage}_{sample_alpha}.json"
